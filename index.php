...
class OurWordFilterPlugin {
  ...
  function ourMenu() {
    ...
    /* ====== svg -> console: btoa(` paste svg code here `); ====== */
    ...
    add_submenu_page('ourwordfilter', 'Word Filter Opions', 'Options', 'manage_options', 'word-filter-options', array($this, 'optionsSubPage'));
    ...
    <div class="wrap">
      ...
      <form method="POST">
        ...
        <label for="plugin_words_to_filter">
          <p>Enter a <strong>comma-separated</strong> list of words to filter from site's content.</p>
        </label>
        <div class="word-filter__flex-container">
          <textarea name="plugin_words_to_filter" id="plugin_words_to_filter" placeholder="bad, mean, awful, horrible">
            <?php ltrim(esc_textarea( get_option('plugin_words_to_filter') )); ?>
          </textarea>
        </div>
